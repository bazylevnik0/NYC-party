...
export default function Stream(props) {
    ...
    (async () => {
        let url_face = window.location.href+'haarcascade_frontalface_default.xml';
        let url_eye = window.location.href+'haarcascade_eye.xml';
              
        try {
            let response_face = await fetch(url_face);
            faceCascade.load(await response_face.text());

            let response_eye = await fetch(url_eye);
            eyeCascade.load(await response_eye.text());
        } catch (error) {
            console.log(error)
        }
    })();
